...
(function(f, g, z) {
	function A() {
		for (var a = 1; a < arguments.length; a++)
			for (var d in arguments[a])
				arguments[a].hasOwnProperty(d) && (arguments[0][d] = arguments[a][d]);
	return arguments[0]
	}
	function B(a, d) {
	...
	function y(a) {
		v = !0;
		f.addEventListener
			? f.addEventListener("scroll", a, !1)
			: f.attachEvent
				? f.attachEvent("onscroll", a)
				: f.onscroll = a
	}
	var F = {
			minHeight: 0,
		...
		u = function(e) {
			...
			function L(c, d, n, e) {
				if (r)
					...
					a.pixelDepth && 2 < arguments.length && n > k && (k = n, r({
						event: "ScrollDistance",
						eventCategory: "Scroll Depth",
					...
					if (w && (f[m]("send", "event", "Scroll Depth", c, d, 1, {nonInteraction: a.nonInteraction}), a.pixelDepth && 2 < arguments.length && n > k && (k = n, f[m]("send", "event", "Scroll Depth", "Pixel Depth", x(n), 1, {nonInteraction: a.nonInteraction})), a.userTiming && 3 < arguments.length))
						f[m]("send", "timing", "Scroll Depth", c, e, d);
					J && (_gaq.push([
						"_trackEvent",
						"Scroll Depth",
						c,
						...
						1,
						a.nonInteraction
					]), a.pixelDepth && 2 < arguments.length && n > k && (k = n, _gaq.push([
						"_trackEvent",
						"Scroll Depth",
						"Pixel Depth",
						x(n),
						1,
						a.nonInteraction
					])), a.userTiming && 3 < arguments.length && _gaq.push([
						"_trackTiming",
						"Scroll Depth",
						c,
						e,
					...
					if (K) {
						...
						a.PiwikGoal && h > I && (I = h, q = "_paq.push(['trackGoal', " + u(h) + ", 0]);", b(q));
			...
			function N(a, d) {
				...
				return function() {
					...
					e = arguments;
					0 >= p
						? (clearTimeout(g), g = null, l = k, f = a.apply(b, e))
						: g || (g = setTimeout(h, p));
					return f
				}
			}
			...
			if (!(C() < a.minHeight)) {
				a.gaGlobal
					...
					: "function" === typeof ga
						? (w = !0, m = "ga")
						: "function" === typeof __gaTracker && (w = !0, m = "__gaTracker");
				"undefined" !== typeof _gaq && "function" === typeof _gaq.push && (J = !0);
				"undefined" !== typeof _paq && "function" === typeof _paq.push && (K = !0);
				"function" === typeof a.eventHandler
					? r = a.eventHandler
					: "undefined" === typeof dataLayer || "function" !== typeof dataLayer.push || a.gtmOverride || (r = function(a) {
						dataLayer.push(a)
					});
				...
				t = N(function() {
					var c = C(),
						b = f.innerHeight || g.documentElement.clientHeight || g.body.clientHeight,
						b = D() + b,
						c = {
							10: parseInt(.1 * c, 10),
							20: parseInt(.2 * c, 10),
						...
						d = + new Date - O;
					if (p.length >= 10 + a.elements.length)
						v = !1,
						E(f, "scroll", void 0);
					else {
						if (a.elements)
							for (var e = a.elements, k = 0; k < e.length; k++) {
								...
								if (!B(p, h)) {
									...
									"string" === typeof h
										? (
											l = h, l = "undefined" !== typeof f.jQuery
											? f.jQuery(l).get(0)
											: "undefined" !== typeof g.querySelector
												? g.querySelector(l)
												: "#" == l.charAt(0)
													? g.getElementById(l.substr(1))
													: z)
										: l = h;
						...
						if (a.percentage)
							for (var m in c)
								c.hasOwnProperty(m) && (e = c[m], !B(p, m) && b >= e && (L("Percentage", m, b, d), p.push(m)))
					}
				}, 500);
				y(t)
			}
	...
	f.gascrolldepth = {
		...
		addElements: function(e) {
			if ("undefined" != typeof e && "[object Array]" === Object.prototype.toString.call(e)) {
				for (var d = 0; d < e.length; d++) {
					var b = e[d];
					-1 == a.elements.indexOf(b) && a.elements.push(b)
				}
				v || y()
			}
		},
		removeElements: function(e) {
			if ("undefined" != typeof e && "[object Array]" === Object.prototype.toString.call(e))
				for (var d = 0; d < e.length; d++) {
					var b = e[d],
						f = a.elements.indexOf(b);
					-1 < f && a.elements.splice(f, 1);
					b = p.indexOf(b);
					-1 < b && p.splice(b, 1)
				}
			}
